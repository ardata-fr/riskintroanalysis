...
What's left after using `validate_dataset_content(..., table_name = "epi_units")` 
is the required "epi_units" dataset that is compatible with the rest of the 
