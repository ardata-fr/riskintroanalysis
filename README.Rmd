...
plot_risk(ri_borders, interactive = TRUE)
```
...
plot_risk(ri_animal_mobility, interactive = TRUE)
```
...
plot_risk(ri_road_access, interactive = TRUE)
```
...
plot_risk(summarised_risks, , interactive = TRUE)
```
