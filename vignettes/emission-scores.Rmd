...
The emission risk for each country is calculated from multiple risk factors. Each factor is weighted according to its importance, and the weighted sum produces a final emission risk score ranging from 0 (no risk) to 12 (maximum risk).

You can see all the details for this calculation here: `calc_emission_risk()`
...
plot_emission_risk(emission_risk_table)
```
